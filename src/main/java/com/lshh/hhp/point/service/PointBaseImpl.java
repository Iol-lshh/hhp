...
public class PointBaseImpl implements PointBase {
    ...
    @Override
    @Transactional
    public PointDto add(PaymentDto paymentDto) {
    ...
    @Transactional
    public List<PointDto> subtract(List<OrderItemDto> purchaseDtos) throws Exception {
    ...
    @Lock(LockModeType.PESSIMISTIC_READ)
    @Transactional
    public List<PointDto> cancelSubtract(List<OrderItemDto> purchaseDtoList) throws Exception {
